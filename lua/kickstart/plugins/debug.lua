...
vim.keymap.set('n', '<leader>ds', function() require('dap').continue() end, { desc = 'Debug: Start' })
-- prefer to use dc to continue
...
vim.keymap.set('n', '<leader>dd', function() require('dap').clear_breakpoints() end, { desc = 'Debug: Clear breakpoints' })
